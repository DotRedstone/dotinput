...
GitHub repository and an immutable `v0.2.0` tag. Replace `OWNER` in
`PKGBUILD`, generate the real checksum with `updpkgsums`, then publish the
PKGBUILD in the separate AUR packaging repository.
