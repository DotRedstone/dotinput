...
const defaults = {
  ...
  design: { panel_radius: 12, highlight_radius: 9, panel_outline_width: 1.25, content_padding: 12, panel_inner_opacity: 0.5, highlight_inner_opacity: 0.24 },
};

let state = structuredClone(defaults);
let preview = { layout: "horizontal", candidateCount: 5 };
let language = navigator.language.toLowerCase().startsWith("zh") ? "zh" : "en";
const designControls = { "panel-radius": ["panel_radius", "panel-radius-value"], "highlight-radius": ["highlight_radius", "highlight-radius-value"], "outline-width": ["panel_outline_width", "outline-width-value"], "content-padding": ["content_padding", "content-padding-value"], "panel-opacity": ["panel_inner_opacity", "panel-opacity-value"], "highlight-opacity": ["highlight_inner_opacity", "highlight-opacity-value"] };
